...
import type { ControllerConfig, RunningServer, ServerAdapter } from 'src/api/http/interfaces.js';
...
import type { OnShutdownHook, OnStartHook } from 'src/api/app/lifecycle.js';
